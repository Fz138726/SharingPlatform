...
def getInfoFromIMoocForCPlusPlus():
    ...
    for item in courseCardContain:
        ...
        course=Course(CourseName,"iMooc","C++",CourseURL)
...
print(getInfoFromIMoocForCPlusPlus())   #测试输出结果