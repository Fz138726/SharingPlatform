...
def aiqiyi_Python():
    ...
    while page<=30:
        i=1
        while i<=10:
            xpath='//*[@id="__layout"]/div/div[1]/div/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div[2]/div/ul/li[%s]/div/div[1]/a'%i
            ...
            i=i+1
        but=browser.find_element_by_xpath('//*[@id="__layout"]/div/div[1]/div/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/div[3]/div/a')
        but.click()
        page=page+1
    return mylist
