...
def getInfoFromIMoocForPHP():
    ...
    while uu<=num-2:
        urls = ["https://www.imooc.com/course/list?c=php" + "&page={}".format(str(i)) for i in range(1, num)]
        res=requests.get(urls[uu])
        ...
        for item in courseCardContain:
            ...
            course=Course(CourseName,"iMooc","PHP",CourseURL)
...
print(getInfoFromIMoocForPHP())   #测试输出结果
# getInfoFromIMoocForPHP()